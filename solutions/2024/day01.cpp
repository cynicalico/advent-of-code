...
std::tuple<List, List> AOC_NS(2024, 01)::parse_input(const std::filesystem::path &input_path) {
    List l1, l2;
...
std::int32_t AOC_NS(2024, 01)::p1(std::tuple<List, List> &input) {
...
std::int32_t AOC_NS(2024, 01)::p2(std::tuple<List, List> &input) {
