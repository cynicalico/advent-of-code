...
std::vector<BatteryBank> aoc2025::day03::parse_input_file(const std::filesystem::path &input_path) {
    // clang-format off
...
Joltage aoc2025::day03::p1(std::vector<BatteryBank> &input) {
...
Joltage aoc2025::day03::p2(std::vector<BatteryBank> &input) {
